...
export type ServerMsg =
    ...
    | { op: 'advertise'; channels: Array<{ id: number; topic: string; schemaName: string; schema: string; encoding: string }> }
...
export interface ChannelIndex {
    byId: Map<number, { topic: string; type: string; encoding: string; schema: string; schemaEncoding: string }>
